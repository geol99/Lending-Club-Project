...
head(YhatTestProbLR)
calibProbs = calibration(YtestRelevel ~ YhatTestProbLR$'Fully Paid', cuts = 5)
xyplot(calibProbs)
```
```{r confusion matrix}
YhatTestLR = predict(outLogistic, XtestFull, type = 'raw')
...
rocCurveLR = roc(Ytest, YhatTestProbLR$'Charged Off')
...
calibProbs = calibration(YtestRelevel ~ YhatTestProbLDA$'Fully Paid', cuts = 5)
xyplot(calibProbs)
...
rocCurveLDA = roc(Ytest, YhatTestProbLDA$'Fully Paid')
